...
# Files to write out
outFile <- file.path(outputDir, "AdipMean_repCV_001b_PreMerge_")
...
preproc_train_function = preproc_train_adip_premerge
preproc_test_function = preproc_test_adip_premerge
bag_function = bag_tree
transform_function = NoTransform
