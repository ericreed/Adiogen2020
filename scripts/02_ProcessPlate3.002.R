...
# Files to read in
platFile <- file.path(platDir, "SSF-2155.HHLNVBGX2.unq.refseq.umi.dat")
...
png(AboxplotFile002, width = 1200, height = 600)
creatBoxPlots(eSetCPM[,pData(eSetCPM)$Experiment == "A"], title =  "Experiment A (log2CPM)")
dev.off()

png(BboxplotFile002, width = 1200, height = 600)
...
png(AbarplotFile002, width = 1200, height = 600)
creatBarPlots(eSet[,pData(eSet)$Experiment == "A"], title =  "Experiment A (Total Reads)")
dev.off()

png(BbarplotFile002, width = 1200, height = 600)
...
png(medVmadplotFile002, 400, 400)
...
png(clustMADplotFile002, width = 1000, height = 1000)
...
png(clustExpplotFile002, width = 1000, height = 1000)
MEDclust <- clusEset(eSetMED)
dev.off()


eSetRem <- eSet
saveRDS(eSetRem, eSetRemFile002)
